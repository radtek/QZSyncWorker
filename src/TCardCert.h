 ...
 *				   适用操作系统:Windows环境					 *
 *************************************************************/
#ifndef _TCARDCERT_H_
#define _TCARDCERT_H_
